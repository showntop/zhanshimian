...
Page({
  ...
  onLoad(options) {
    ...
    if (conversationID) api.getAdvisorMessages(conversationID).then((messages) => { this.setData({ messages }); this.scrollToEnd() }).catch(() => wx.removeStorageSync('jianwo_advisor_conversation_id'))
  },
