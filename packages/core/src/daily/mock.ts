...
const SKIN: Record<StyleGene['skinTone'], string> = {
  cool: '冷调',
  warm: '暖调',
  neutral: '中性',
}
const CONTRAST: Record<StyleGene['contrast'], string> = {
  high: '五官对比强',
  medium: '五官对比适中',
  low: '五官对比柔和',
}
const SHOULDER: Record<StyleGene['shoulder'], string> = {
  narrow: '肩偏窄',
  medium: '肩宽适中',
  broad: '肩偏宽',
}
const FRAME: Record<StyleGene['frame'], string> = {
  small: '骨架偏小',
  medium: '骨架适中',
  large: '骨架偏大',
}
const NECK: Record<StyleGene['neck'], string> = {
  short: '颈偏短',
  medium: '颈长适中',
  long: '颈偏长',
}
const FACE: Record<StyleGene['face'], string> = {
  round: '脸型偏圆',
  oval: '脸型偏长',
  square: '脸部轮廓偏方',
  heart: '脸型上宽下窄',
}
const HEIGHT: Record<StyleGene['heightBand'], string> = {
  petite: '身高中等偏下',
  average: '身高中等',
  tall: '身高中等偏上',
}

export const MOCK_CONTENTS: DailyContent[] = [
  // ---------------- 色彩 ----------------
  {
    id: 'c-white-tone',
    type: 'color',
...
export const MOCK_GENE_DEFAULT: StyleGene = {
...
export const MOCK_GENES: Record<string, StyleGene> = {
