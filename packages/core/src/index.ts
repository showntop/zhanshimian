...
export { APP_NAME, APP_SLOGAN, ERROR_COPY, EMPTY_COPY, FEEDBACK_WORDS, HOME_COPY, HOME_TITLE, PRIVACY_NOTE, PROFILE_SETUP_COPY, REPORT_COPY, SCENES, analysisStageText, analysisTimelineText, ANALYSIS_STAGE_TIMELINE, ANALYSIS_FAIL_COPY, greetingByHour, greetingForNow, IMAGE_BADGE_COPY, PRIVACY_SECTION_TITLE, ANALYSIS_STAGE_COPY, OUTFIT_COPY, PURCHASE_COPY, PLAN_DETAIL_COPY, ADVISOR_COPY, FINDING_TONE_COPY, type SceneCopy } from './copy/zh.ts'
export {
  EVENT_NAME_PATTERN,
